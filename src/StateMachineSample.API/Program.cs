...
builder.Services.AddMassTransit(x =>
{
    ...
    x.AddConsumer<StartOrderEventConsumer>();
    x.AddRequestClient<StartOrderEventConsumer>();

    x.AddConsumer<StartOrderFaultEventConsumer>();
    x.AddRequestClient<StartOrderFaultEventConsumer>();
